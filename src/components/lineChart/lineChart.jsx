    ...
    return (
      <div className=" border-2 border-[#ECEEF7] rounded-md  bg-[#FFFFFF] mt-6 ">
        <div className="flex font-bold justify-between p-[33px] ">
          <p className="text-[22px] ">Peek Parking TIme</p>
          <div className="flex justify-center items-center gap-9">
            ...
            <div className="hidden  text-[#1A2B88] sm:flex justify-between p-[10px] rounded-xl cursor-pointer items-center w-[119px] text-[14px] bg-[#F7F7F7] ">
              This Month <img src={img} alt="" />
            </div>
          </div>
        </div>
        <div className="">
