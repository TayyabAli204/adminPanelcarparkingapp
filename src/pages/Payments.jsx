...
//   return (
//     <div className="p-4">
//       <h1 className="text-2xl font-bold mb-4">Booking Payments</h1>
...
//             <th className="py-2">Parking Space</th>
...
//               <td className="py-2">{payment.providerName}</td>
//               <td className="py-2">{payment.parkingSpaceName}</td>
//               <td className="py-2">{payment.paymentMode}</td>
//               <td className="py-2">{payment.total}</td>
